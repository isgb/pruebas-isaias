...
export const createSelfiesTable = () => {
    db.transaction(tx => {
        tx.executeSql(
...
export const createDataUsersTable = () => {
...
export const saveUser = (username, password, tipojornada = null) => {
...
export const validatePassword = (inputPassword, storedHash) => {
    const secretKey = 'a5dcbf8e-3f2b-4e6d-9f8e-2b3d4e6f9a8b';
...
export const saveDataUser = (formdata = null, endpoint = null, email = null, usuarioId = null, jornadaId = null, token = null, refreshtoken = null, tipojornada = null) => {
    db.transaction(tx => {
        tx.executeSql(
            'INSERT INTO data_users (formdata, endpoint, email, usuarioId, jornadaId, token, refreshtoken, tipojornada) VALUES (?, ?, ?, ?, ?, ?, ?, ?);',
            [formdata, endpoint, email, usuarioId, jornadaId, token, refreshtoken, tipojornada],
...
export const getDataUserByFormDataAndEmail = (email, formdata) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const getDataUsersByEmail = (email) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const hasNullTokenByEmail = (email) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const updateTokensByUsername = (username, newToken, newRefreshToken) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const removeDataUserById = (id) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const getDataUserByTipoJornadaAndEmail = (tipojornada, email) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const updateTipoJornadaByEmail = (email, newTipoJornada) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const getTipoJornadaByUsername = (username) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const getSelfiesByJornadaId = (jornadaId) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const getSelfiesByJornadaIdAndUsername = (jornadaId, username) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const getSelfiesByJornadaIdAndUsernameAndTipoJornada = (jornadaId, username, tipoJornada) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
...
export const saveSelfiePhoto = (jornadaId, formdata, username) => {
    db.transaction(tx => {
        tx.executeSql(
...
export const removeSelfiePhotoById = (id) => {
    return new Promise((resolve, reject) => {
        db.transaction(tx => {
            tx.executeSql(
